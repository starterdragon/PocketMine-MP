...
If you don't find what you're looking for there, [talk to a human](https://telegram.me/joinchat/AlErxD3AN_GOgeSAcS0twA). Please do not use our issue tracker for support requests.

### Discussion
- [Forums](https://forums.pmmp.io/)
- [#pmmp + #pocketmine channel IRC](http://webchat.freenode.net/?channels=pmmp,pocketmine)
- [#CS:PMMP Telegram Channel](https://telegram.me/joinchat/AlErxD3AN_GOgeSAcS0twA)
